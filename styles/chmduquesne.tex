...
\setupbodyfont[10pt, calibri]
\setupinterlinespace[line=10pt] % Adjust this value to change the line spacing
\setupwhitespace[0.5mm] % Adjust this value to change the inter-paragraph spacing
...
\definedescription
  ...
  [headstyle=bold, style=normal,
   location=hanging, width=15mm, distance=10mm, margin=0cm]
